  ...
  components: {
    ...
    parameters: {
      CorrelationId: {
        ...
        required: false,
        description:
          "Optional request correlation ID using ASCII letters, digits, period, underscore, colon, or hyphen. A missing or invalid value is replaced with a generated unique ID, which is echoed in the response.",
        schema: {
          type: "string",
          maxLength: 255,
          pattern: "^[A-Za-z0-9._:-]+$",
